(define-abbrev-table
	'global-abbrev-table '(
												 ;; common loved/hated people
												 ("8anais" "Anaïs")
												 ("8ag"    "Anaïs GALLOIS")
												 ("8eg"    "Emmanuel GALLOIS")
												 ("8meg"   "Monsieur Emmanuel GALLOIS")
												 ("8op"    "Olivia PIMPÃO")
												 ("8mp"    "Martine POUGAUD")
												 ("8mmp"   "Madame Martine POUGAUD")
												 ;; 
												 ("8nin" "∉")
												 ("8inf" "∞")
                         ("8alpha" "α")
												 ;; shell commands
												 ("8sditto" "ditto -ck --sequesterRsrc --keepParent src dest")
												 ("8sim" "convert -quality 85% ")
												 ("8sf0" "find . -type f -size 0 -exec rm {} ';'")
 												 ))
